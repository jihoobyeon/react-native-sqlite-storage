...
namespace winrt::SQLitePlugin
{
  void winrt::SQLitePlugin::SQLite::Attach(
  ...
  void winrt::SQLitePlugin::SQLite::Close(
    ...
    std::function<void(std::string)> onFailure) noexcept
  {
    ...
    if (auto strongThis = weak_this.lock()) {
      ...
      if (options.Path == "" || options.Path.empty())
      {
  ...
  winrt::SQLitePlugin::SQLite::SQLite() {};
  ...
  void winrt::SQLitePlugin::SQLite::DeleteDB(
  ...
  void winrt::SQLitePlugin::SQLite::EchoStringValue(
  ...
  void winrt::SQLitePlugin::SQLite::ExecuteSqlBatch(
  ...
  void winrt::SQLitePlugin::SQLite::Open(
  ...
  void winrt::SQLitePlugin::SQLite::BindStatement(sqlite3_stmt* stmt_ptr, int argIndex, const JSValue& arg)
  {
    switch (arg.Type())
    {
  ...
  bool winrt::SQLitePlugin::SQLite::CloseDatabaseIfOpen(const hstring& absoluteDbPath, std::map<hstring, sqlite3*>& openDBs)
  {
  ...
  IAsyncOperation<StorageFile> winrt::SQLitePlugin::SQLite::CopyDbAsync(const StorageFile& srcDbFile, const hstring& destDbFileName)
  {
  ...
  bool winrt::SQLitePlugin::SQLite::ExecuteQuery(sqlite3* dbHandle, const DBQuery& query, JSValue& result)
  {
    if (query.SQL == "")
    {
  ...
  JSValue winrt::SQLitePlugin::SQLite::ExtractColumn(sqlite3_stmt* stmt, int columnIndex)
  {
  ...
  JSValueObject winrt::SQLitePlugin::SQLite::ExtractRow(sqlite3_stmt* stmt)
  {
    JSValueObject row{};
  ...
  IAsyncOperation<StorageFile> winrt::SQLitePlugin::SQLite::ResolveAssetFile(const std::string& assetFilePath, const std::string& dbFileName)
  {
  ...
  hstring winrt::SQLitePlugin::SQLite::ResolveDbFilePath(const hstring dbFileName)
  {
    return ApplicationData::Current().LocalFolder().Path() + L"\\..\\..\\..\\..\\..\\Documents\\" + dbFileName;
  }
} // namespace winrt::SQLitePlugin
