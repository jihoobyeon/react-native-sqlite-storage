...
#if __has_include("codegen\NativeSQLitePluginDataTypes.g.h")
  #include "codegen\NativeSQLitePluginDataTypes.g.h"
#endif
#include "codegen\NativeSQLitePluginSpec.g.h"
...
namespace winrt::SQLitePlugin
{
  ...
  REACT_MODULE(SQLite);
  struct SQLite : std::enable_shared_from_this<SQLite>
  {
  public:
